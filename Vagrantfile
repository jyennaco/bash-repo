...
Vagrant.configure("2") do |config|
  ...
  config.vm.network :forwarded_port, guest: 80, host: 9311
  ...
  config.vm.provision  "shell", inline: "chmod +x /vagrant/scripts/init.sh ; /vagrant/scripts/init.sh"
